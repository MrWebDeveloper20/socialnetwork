...
const Tools = () => {
  ...
  return (
    <div className="p-3 my-2 flex flex-col justify-center items-center">
      <h1 className='text-xl font-serif font-bold mb-3'>Download Instagram Image</h1>
      <input
        onChange={() => {
          changeURL(event)
        }}
        className="ring-2 font-serif rounded-lg p-3 text-left w-1/3"
        type="text"
        name="search"
        id="search"
        placeholder='Insert Instagram Image link'
      />
